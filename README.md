...
Obs. I got two blue screens while using WriteFile() and ReadFile() together in a loop (while(1)) in overlapped mode. I guess it was just too fast for the buffer.
